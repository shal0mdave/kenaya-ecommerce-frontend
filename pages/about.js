				...
				<Container>
					<Row>
						...
						<Col md={7}>
							...
							<p className={Styles.AboutText}>Our feet are deeply planted in our local community. To break through, we use our resources to empower and employ local artisans. Kenaya is a 100% Mauritius-made brand. Our micro collection includes items in quantities of no more than 5 or 8 pieces, in sizes ranging from S to XL. Our goal is to avoid overproduction while still allowing everyone to express themselves through their clothing choices.</p>
