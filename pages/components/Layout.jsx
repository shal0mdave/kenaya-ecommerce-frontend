    ...
    return (
        <Fragment>
            <Head>
                ...
                <meta name="description" content={props.description || 'Online Shopping for the latest clothes and fashion.'} />
                ...
                <meta property="og:url" content={props.url || 'https://kenaya.com/'} />
                <meta property="og:image" content={props.image || 'https://kenaya.com/img/ship.png'} />
